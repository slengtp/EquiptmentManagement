...
<body>
		...
		<div class="row-fluid">
			...
			<div class="span9 mt10 pb40">
				...
				<form role="form" action="AdminServlet?action=add" method="post">
					<div class="form-group">
						<label for="adminID">管理员ID</label>
						<input type="text" name="adminID" id="adminID" class="form-control" placeholder="请输入管理员ID" />
					</div>
					
					<div class="form-group">
						<label for="adminName">姓名</label>
						<input type="text" name="adminName" id="adminName" class="form-control" placeholder="请输入姓名" />
					</div>
					...
					<div class="checkbox">
						<label> <input type="checkbox" name="adminIsSuper"> 是否是超级管理员</label>
					</div>
